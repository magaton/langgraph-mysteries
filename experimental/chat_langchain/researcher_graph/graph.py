...
from experimental.utils import load_chat_model

from experimental.chat_langchain.configuration import AgentConfiguration
from experimental.chat_langchain.researcher_graph.state import QueryState, ResearcherState
...
async def retrieve_documents(
    ...
    page_contents: List[str] = [
        "LangChain is a framework designed for developing applications powered by large language models (LLMs). It simplifies the entire lifecycle of LLM application development.",
        "LangGraph is a library within the LangChain framework specifically designed for building stateful, multi-actor applications using large language models (LLMs). It enables developers to create complex workflows by modeling agent behaviors as graphs.",
        "LangSmith is a platform designed to support the development, monitoring, and evaluation of production-grade applications powered by large language models (LLMs)."
    ]

    # Create a List[Document] from List[str]
    documents: List[Document] = [Document(page_content=content) for content in page_contents]
